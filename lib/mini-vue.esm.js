...
export { Fragment, Text, computed, createApp, createAppApi, createComponentInstance, createRenderer, createTextVNode, createVNode, effect, getCurrentInstance, h, inject, isReactive, isReadonly, isRef, provider, proxyRefs, reactive, readonly, ref, renderSlot, setupComponent, shallowReadonly, stop, unRef };
